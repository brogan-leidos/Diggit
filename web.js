...
function refreshHealthBar() {
    ...
    if (percentRemaining >= 60) { bar.style.color = "green"; }
    if (percentRemaining < 60 && percentRemaining > 30) { bar.style.color = "yellow"; }
    if (percentRemaining <= 30) { bar.style.color = "red"; }        
}
